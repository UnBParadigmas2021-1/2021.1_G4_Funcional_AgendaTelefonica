...
cadastroContato :: IO()
cadastroContato = do { putStrLn "Selecione a opção que deseja realizar";

	}

listarContato :: IO()
listarContato = do { putStrLn "Selecione a opção que deseja realizar";

	}

terceiroSubMenu :: IO()
terceiroSubMenu = do { putStrLn "Selecione a opção que deseja realizar";

	}

historicoLigacoes :: IO()
historicoLigacoes = do { putStrLn "Selecione a opção que deseja realizar";
